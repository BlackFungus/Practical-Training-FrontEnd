...
const MyBottonLogin = function (props) {
    ...
    return (<Button variant="outlined" size="large" className={classes.button} onClick={handleLogin(props.state)} >登陆</Button>)
}

const MyBottonRegister = function (props) {
    const classes = useStyles()
    return (<Button variant="outlined" size="large" className={classes.button} onClick={props.register} >注册</Button>)
}
